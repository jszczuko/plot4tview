...
func (plot *BarPlot) drawPoints(screen tcell.Screen, x int, y int, width int, height int) {
	...
	for _, point := range plot.data {
		...
		for i := possY; i <= y+height; i++ {
			screen.SetContent(possX, i, ' ', nil, plot.style4Point(point))
		}

	}
}

func (plot *BarPlot) drawXaxisLines(screen tcell.Screen, x int, y int, width int, height int, xOffset int) (xm int, wm int) {
...
func (plot *BarPlot) drawYaxisLines(screen tcell.Screen, x int, y int, width int, height int) (ym int, hm int) {
...
func (plot *BarPlot) drawYaxisDescription(screen tcell.Screen, x int, y int, width int, height int) {
	tview.Print(screen, plot.yaxisText, x, y, width, plot.xaxisAligment, tcell.ColorRed)
}

func (plot *BarPlot) drawXaxisDescription(screen tcell.Screen, x int, y int, width int, height int) {
